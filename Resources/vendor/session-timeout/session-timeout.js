        ...
        function (e, t, n) {
            ...
            t.default = function (e) {
                var t,
                    ...
                    d = function () {
                        r.classList.remove("sessionTimeout--hidden"), clearTimeout(t);
                    },
                    f = function () {
                ...
                c.addEventListener("click", function () {
                    ...
                    l.addEventListener("click", function () {
                        r.classList.add("sessionTimeout--hidden");
                    ...
                    r.classList.add("sessionTimeout", "sessionTimeout--hidden"),
                    i.classList.add("sessionTimeout-modal"),
                    a.classList.add("sessionTimeout-title"),
                    s.classList.add("sessionTimeout-content"),
                    u.classList.add("sessionTimeout-buttons"),
                    c.classList.add("sessionTimeout-btn", "sessionTimeout-btn--secondary"),
                    l.classList.add("sessionTimeout-btn", "sessionTimeout-btn--primary"),
                    (a.innerText = o.titleText),
                    (s.innerText = o.message),
                    ...
                    (t = setTimeout(d, o.warnAfter)),
                    (n = setTimeout(f, o.timeOutAfter));
            };
        },
        function (e, t, n) {
            var o = n(2);
