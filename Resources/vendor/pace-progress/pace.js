  ...
  Bar = (function() {
    ...
    Bar.prototype.getElement = function() {
      ...
      if (this.el == null) {
        ...
        this.overlay.setAttribute("id", "pace-overlay-layer");
        //
        ...
        if (targetElement.firstChild != null) {
          ...
          targetElement.insertBefore(this.overlay, targetElement.firstChild);
        } else {
          targetElement.appendChild(this.el);
          targetElement.appendChild(this.overlay);
        }
      }
      return this.el;
    };
    ...
    Bar.prototype.finish = function() {
      ...
      //Customize
      var overlay = document.getElementById("pace-overlay-layer");
