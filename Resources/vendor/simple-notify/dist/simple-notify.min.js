...
var Notify = function () {
    ...
    var t = function (t) {
        ...
        m = function (t) {
            t.wrapper.classList.add("notify--wiggle"), setTimeout((function () {
                t.wrapper.classList.add("notify--wiggleIn")
            }), 100)
        },
        n = function (t) {
            t.wrapper.classList.remove("notify--wiggleIn"), setTimeout((function () {
                t.wrapper.remove()
            }), t.speed)
        };
    return function () {
        ...
        return o.prototype.checkRequirements = function () {
            ...
            var t;
            this.customWrapper ? this.wrapper = (t = this.customWrapper, (new DOMParser).parseFromString(t, "text/html").body.childNodes[0]) : this.wrapper = document.createElement("div"), this.wrapper.style.setProperty("--gap", this.gap + "px"), this.wrapper.style.transitionDuration = this.speed + "ms", this.wrapper.classList.add("notify"), this.wrapper.classList.add("notify--type-" + this.type), this.wrapper.classList.add("notify--" + this.status), this.autoclose && this.wrapper.style.setProperty("--timeout", "" + (this.autotimeout + this.speed)), this.autoclose && this.wrapper.classList.add("notify-autoclose"), this.customClass && this.wrapper.classList.addMany(this.customClass)
            ...
            switch (this.effect) {
                ...
                case "slide":
                    ...
                    break;
                case "wiggle":
                    this.selectedNotifyInEffect = m, this.selectedNotifyOutEffect = n;
                    break;
                default:
                    this.selectedNotifyInEffect = t, this.selectedNotifyOutEffect = e
            }
